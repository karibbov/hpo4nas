...
def _():
    ...
    scenario = Scenario({"run_obj": "quality",  # we optimize quality (alternative to runtime)
                         "wallclock-limit": 600,  # max duration to run the optimization (in seconds)
...
def run_smac(search_space, dataset, seed, output_path):
    """
    Runs a SMAC optimizer.
